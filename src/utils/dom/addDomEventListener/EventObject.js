...
const eventNormalizers = [{
  ...
  fix( event, nativeEvent ) {
    if ( itis.Undefined( event.which )) {
      event.which = !itis.Undefined( nativeEvent.charCode )
  ...
  fix( event, nativeEvent ) {
    ...
    if ( target && itis.Undefined( event.pageX ) && !itis.Undefined( nativeEvent.clientX )) {
...
class DomEventObject extends EventBaseObject {
  ...
  constructor( nativeEvent ) {
    ...
    const isNative = itis.Function( nativeEvent.stopPropagation ) ||
      itis.Boolean( nativeEvent.cancelBubble );
